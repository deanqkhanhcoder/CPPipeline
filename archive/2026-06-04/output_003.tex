...
\usepackage{amsmath, amssymb, geometry, mdframed, titlesec, fancyhdr, xcolor, listings}
...
\newmdenv[linecolor=rulecolor, backgroundcolor=white, linewidth=1pt, roundcorner=5pt]{constraintbox}
...
\newcommand{\exmp}[2]{
    \begin{inputbox}#1\end{inputbox}
    \begin{outputbox}#2\end{outputbox}
}
