...
\usepackage{amsmath, amssymb, geometry, mdframed, titlesec, fancyhdr, xcolor}
...
\newmdenv[linecolor=rulecolor, backgroundcolor=white, linewidth=1pt, roundcorner=5pt]{problembox}
\newmdenv[linecolor=rulecolor, backgroundcolor=codebg, linewidth=1pt, roundcorner=5pt]{inputbox}
\newmdenv[linecolor=rulecolor, backgroundcolor=codebg, linewidth=1pt, roundcorner=5pt]{outputbox}
\newmdenv[linecolor=rulecolor, backgroundcolor=white, linewidth=1pt, roundcorner=5pt]{example}
...
\newcommand{\explanation}[1]{
    \vspace{0.5cm}
    \noindent \textbf{Giải thích:} #1
}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Tài liệu Competitive Programming}
\fancyfoot[C]{\thepage}

\begin{document}
\title{\textbf{Bộ 10 Bài Codeforces (Stress Test)}}
\author{CP Pipeline Auto-Orchestrator}
\date{\today}
\maketitle
\tableofcontents
\newpage
...
\newpage
\problem{F. Bánh ngọt là một lời nói dối}{Codeforces 2232F}

\section*{Đề bài}
Để kết thúc bữa tiệc, Alice quyết định nấu vài chiếc bánh xèo cho bạn bè của mình.

Alice có $n$ chiếc bánh xèo chưa nấu nhưng chỉ có 2 cái chảo. Ban đầu, $\min(n, 2)$ chiếc bánh xèo đầu tiên được đặt trên chảo, và tất cả bánh xèo đều có độ chín là 0.

Để nấu bánh xèo, Alice có thể thực hiện hai thao tác sau với số lần tùy ý:
\begin{itemize}
    \item Nấu hai chiếc bánh xèo trên chảo trong 1 phút. Bánh xèo trên chảo thứ nhất sẽ tăng độ chín thêm $a$, và bánh xèo trên chảo thứ hai sẽ tăng độ chín thêm $b$.
    \item Phục vụ chiếc bánh xèo thứ nhất, di chuyển chiếc bánh xèo thứ hai sang chảo thứ nhất, và thêm một chiếc bánh xèo chưa nấu mới vào chảo thứ hai (nếu còn bánh xèo chưa nấu). Lưu ý rằng thao tác này không mất thời gian, và có thể được thực hiện nhiều lần liên tiếp.
\end{itemize}

Lưu ý rằng nếu chỉ còn lại một chiếc bánh xèo, nó sẽ nằm trên chảo thứ nhất, tăng $a$ độ chín mỗi phút cho đến khi Alice quyết định phục vụ nó.

Một chiếc bánh xèo được nấu chín hoàn hảo nếu và chỉ nếu độ chín của nó bằng chính xác $k$.

Hãy giúp Alice tìm số lượng tối đa những chiếc bánh xèo được nấu chín hoàn hảo mà cô ấy có thể phục vụ.

\section*{Dữ liệu vào}
Mỗi bài test bao gồm nhiều test cases. Dòng đầu tiên chứa số lượng test cases $t$ ($1 \le t \le 1000$). Mô tả của các test cases theo sau.

Dòng duy nhất trong mỗi test case chứa 4 số nguyên $n, a, b$ và $k$ ($1 \le n, a, b, k \le 10^9$) — số lượng bột bánh xèo Alice có, lượng độ chín mà bánh xèo trên chảo thứ nhất tăng sau mỗi phút, lượng độ chín mà bánh xèo trên chảo thứ hai tăng sau mỗi phút, và lượng độ chín mà bánh xèo cần đạt được để trở nên chín hoàn hảo.

\section*{Dữ liệu ra}
Với mỗi test case, in ra số lượng tối đa những chiếc bánh xèo được nấu chín hoàn hảo mà Alice có thể làm.
...
\explanation{
Trong test case đầu tiên, Alice có thể nấu chín hoàn hảo tất cả bánh xèo theo từng mẻ 2 chiếc. Do đó, số lượng bánh xèo chín hoàn hảo tối đa là 17.

Trong test case thứ hai, Alice sẽ luôn làm quá lửa tất cả bánh xèo vì cả hai chảo đều quá nóng. Do đó, số lượng bánh xèo chín hoàn hảo tối đa là 0.

Trong test case thứ ba, Alice có thể để hai chiếc bánh xèo đầu tiên trên chảo trong 3003 phút, sau đó phục vụ cả hai, một chiếc chưa chín hẳn và một chiếc chín hoàn hảo. Đối với chiếc bánh xèo cuối cùng, cô ấy để nó trên chảo trong 10101 phút trước khi phục vụ để nó chín hoàn hảo. Vì không có cách nào để nấu chín hoàn hảo hai chiếc bánh xèo đầu tiên (vào thời điểm chiếc đầu tiên chín hoàn hảo, chiếc thứ hai sẽ bị quá lửa), số lượng bánh xèo chín hoàn hảo tối đa là 2.
}
