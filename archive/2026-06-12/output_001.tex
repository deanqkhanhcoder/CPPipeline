...
% ── lstlisting inside inputbox/outputbox: remove double spacing ──
% When lstlisting is placed inside mdframed, the list environment
% adds \topsep + \partopsep ON TOP of mdframed innertopmargin.
% Override: zero out spacing when inside sample boxes.
...
\problem{Test Problem}{Codeforces}
