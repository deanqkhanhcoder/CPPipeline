...
3. `.agents/skills/cp-pipeline/SKILL.md`: Cập nhật lưu trình xử lý PDF Handling làm một pipeline bổ trợ song song với Quy trình HTML.
4. `.agents/skills/cp-latex/SKILL.md`: Bổ sung luật không phân biệt HTML/PDF để đảm bảo Output duy nhất là Template chuẩn.

## Cập nhật tài liệu kiến thức
1. Tạo `.agents/knowledge/pdf_statement_handling.md`: Ghi chép chi tiết cách làm việc với PDF, bao gồm đọc trực tiếp, kết xuất ảnh dự phòng, và các lỗi thường gặp (Toán học biến dạng, Nhiều bài gộp chung file).
